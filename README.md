...
从 [GitHub Releases](https://github.com/Ring1003/CodexPlusPlus/releases) 下载最新版安装包：
...
本仓库是 [Ring1003/CodexPlusPlus](https://github.com/Ring1003/CodexPlusPlus) 的 fork，已移除原仓库内置的全部中转站 / 赞助商广告与远程广告列表，仅保留 Codex++ 的核心增强能力（中转注入、会话管理、增强功能等）。
