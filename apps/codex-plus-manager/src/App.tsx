      ...
      <Panel>
        ...
        <CardContent>
          <div className="metric-list">
            ...
            <Metric label={t("项目地址")} value="github.com/Ring1003/CodexPlusPlus" />
          </div>
          <Toolbar>
            <Button onClick={() => void actions.openExternalUrl("https://github.com/Ring1003/CodexPlusPlus")} variant="secondary">
              <ExternalLink className="h-4 w-4" />
              {t("打开项目主页")}
            </Button>
            <Button onClick={() => void actions.openExternalUrl("https://github.com/Ring1003/CodexPlusPlus/issues")} variant="secondary">
              <ExternalLink className="h-4 w-4" />
              {t("反馈问题")}
            </Button>
          </Toolbar>
