...
export const EN_PLAIN: Record<string, string> = {
  ...
  "Fast 按钮": "Fast button",
  "在线升级": "Online upgrade",
  "在线升级检查": "Online upgrade check",
  "在线升级进度": "Online upgrade progress",
  "尚未检查更新；在线升级会自动下载并安装，无需手动操作。": "No update checked yet; online upgrade downloads and installs automatically, no manual action required.",
  ...
  "正在在线升级…": "Upgrading online…",
  "正在在线下载更新…": "Downloading update online…",
  "正在检查可用更新…": "Checking for available updates…",
  "在线升级失败，请查看错误提示后重试。": "Online upgrade failed. Check the error message and retry.",
  ...
  "版本信息、项目链接、在线升级、日志与诊断": "Version info, project links, online upgrade, logs and diagnostics",
  "状态": "Status",
